  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-evenly" }}>
      ...
      <Box
        ...
        {...{ addArrow, setArrows, handler: "topRight", boxId: "box2_1" }}
      />
      <Box
        text="second element"
        {...{ addArrow, setArrows, handler: "topRight", boxId: "box2_2" }}
      />

      <Box
        text="second element"
        {...{ addArrow, setArrows, handler: "topRight", boxId: "box3_1" }}
      />

      <Box
        text="second element"
        {...{ addArrow, setArrows, handler: "topRight", boxId: "box3_2" }}
      />

      <Box
        text="second element"
        {...{ addArrow, setArrows, handler: "topRight", boxId: "box4_2" }}
      />

      <Box
        text="second element"
        {...{ addArrow, setArrows, handler: "topRight", boxId: "box4_1" }}
      />
